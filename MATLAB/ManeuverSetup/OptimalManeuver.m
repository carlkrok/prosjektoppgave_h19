...
for thisManeuverStartTimeIndex = 1 : numStartTimes
    ...
    [r0ECI_target, v0ECI_target] = nextStateTimeStep( muEarth, r0ECI_target, v0ECI_target, thismaneuverStartTime, anomalyErrorTolerance, anomalyMaxIterations );
    [r0ECI_chaser, v0ECI_chaser] = nextStateTimeStep( muEarth, r0ECI_chaser, v0ECI_chaser, thismaneuverStartTime, anomalyErrorTolerance, anomalyMaxIterations );
    
    for thisManouverLengthIndex = 1 : numLengths
        
        thisManouverLength = maneuverLengths( thisManouverLengthIndex );

        [rECIEnd_target, vECIEnd_target] = nextStateTimeStep( muEarth, r0ECI_target, v0ECI_target, thismaneuverStartTime + thisManouverLength, anomalyErrorTolerance, anomalyMaxIterations );

        [ deltaVStart, deltaVEnd, vIntersectOrbit ] = interceptOrbit( r0ECI_chaser, v0ECI_chaser, rECIEnd_target, vECIEnd_target, thismaneuverStartTime + thisManouverLength, orbitType, muEarth, anomalyErrorTolerance, anomalyMaxIterations );
