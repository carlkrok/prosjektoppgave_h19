...
text( rECI_targetX( 1 ), rECI_targetY( 1 ), rECI_targetZ( 1 ), 'Target Initial Point','FontSize', 15)
text( rECI_chaserX0(1), rECI_chaserY0(1), rECI_chaserZ0(1), 'Chaser Initial Point','FontSize', 15)
text( rECI_chaserX0( end ), rECI_chaserY0( end ), rECI_chaserZ0( end ), 'Chaser Maneuver Start','FontSize', 15)
...
text( rECI_chaserX( end ), rECI_chaserY( end ), rECI_chaserZ( end ), 'Chaser Point of Rendezvous','FontSize', 15 )
