...
title('Chaser Maneuvers in Target LVLH')
h1 = plot3( rLVLH_chaser1_X0, rLVLH_chaser1_Y0, rLVLH_chaser1_Z0,'LineWidth',1.5,'Color','r' )
h2 = plot3( rLVLH_chaser1_X1, rLVLH_chaser1_Y1, rLVLH_chaser1_Z1,'LineWidth',1.5,'Color','r' )
h3 = plot3( rLVLH_chaser2_X0, rLVLH_chaser2_Y0, rLVLH_chaser2_Z0,'LineWidth',1.5,'Color','b' )
h4 = plot3( rLVLH_chaser2_X1, rLVLH_chaser2_Y1, rLVLH_chaser2_Z1,'LineWidth',1.5,'Color','b' )
h5 = plot3( rLVLH_chaser3_X0, rLVLH_chaser3_Y0, rLVLH_chaser3_Z0,'LineWidth',1.5,'Color','g' )
h6 = plot3( rLVLH_chaser3_X1, rLVLH_chaser3_Y1, rLVLH_chaser3_Z1,'LineWidth',1.5,'Color','g' )
h7 = plot3( rLVLH_chaser4_X0, rLVLH_chaser4_Y0, rLVLH_chaser4_Z0,'LineWidth',1.5,'Color','c' )
h8 = plot3( rLVLH_chaser4_X1, rLVLH_chaser4_Y1, rLVLH_chaser4_Z1,'LineWidth',1.5,'Color','c' )
%h9 = plot3( rLVLH_chaserX1_unactuated, rLVLH_chaserY1_unactuated, rLVLH_chaserZ1_unactuated,'LineWidth',1.5 )
plot3( 0, 0, 0, 'r*' )
axis equal
axis on
grid on
