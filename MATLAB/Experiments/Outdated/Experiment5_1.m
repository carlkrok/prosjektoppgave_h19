...
for plotIndex = 1 : MCsampleNum
    plot(MCdeviationTimes( plotIndex ), norm(MC_HPOP_PosEnd( plotIndex, : )' - MC_HPOP_PosEnd( 6, : )), '*')
end
xlabel('Delay Time [s]')
ylabel('Distance [km]')
hold off
...
plot3(0,0,0,'k.')
for plotIndex = 1 : MCsampleNum
	plot3((MC_HPOP_PosEnd( plotIndex, 1 ) - MC_HPOP_PosEnd( 6, 1 )), (MC_HPOP_PosEnd( plotIndex, 2 ) - MC_HPOP_PosEnd( 6, 2 )), (MC_HPOP_PosEnd( plotIndex, 3 ) - MC_HPOP_PosEnd( 6, 3 )), '*')
end
hold off
