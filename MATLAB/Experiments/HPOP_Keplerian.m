...
rECIManeuverStartIdeal_chaser = chaserInitialEph( end, 2:4 )'./10^3;
vECIManeuverStartIdeal_chaser = chaserInitialEph( end, 5:7 )'./10^3;
...
rECIManouverEnd_targetKeplerian = targetKeplerianEph( end, 2:4 )'./10^3;
vECIManouverEnd_targetKeplerian = targetKeplerianEph( end, 5:7 )'./10^3;
