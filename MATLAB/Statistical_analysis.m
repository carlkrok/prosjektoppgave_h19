...
figure(80)
set(gca,'FontSize',30)
%set(gcf,'renderer','Painters','Position', [10 10 1300 300])
...
b = plot_gaussian_ellipsoid(mean1, cov1, 3);
...
legend([plotHandles(1:3); b],'PC1','PC2','PC3','3\sigma','Location','eastoutside')
