...
doy = finddays(year, mon, day, hour, minute, sec);

[glong, glat, alt] = Geodetic(r_ECEF);
alt = alt/1000;
stl = glong + gast;
stl = mod(stl,2*pi);
...
f107 = swd_1(31);  % solar radio noise flux (jansky)
f107a = swd_1(33); % 162-day average F10 (jansky)
...
global sw swc plg dfa ctloc stloc c2tloc s2tloc c3tloc s3tloc apdf day_
