...
initialVelBXScaleEroor = 0.99;
initialVelBYScaleEroor = 0.99;
initialVelBZScaleEroor = 0.99;
...
[rECI_CX, rECI_CY, rECI_CZ, vECI_CX, vECI_CY, vECI_CZ, sampleT_ECIC] = ECITrajectory( r0ECI_C, v0ECI_C, anomalyErrorTolerance, anomalyMaxIterations, orbitPeriod_A, numPeriods, numSamples, muEarth );
...
plot3( rECI_B1X, rECI_B1Y, rECI_B1Z )
plot3( rECI_B2X, rECI_B2Y, rECI_B2Z )
plot3( rECI_CX, rECI_CY, rECI_CZ, '--' )
axis equal
% Draw the initial position vectors:
